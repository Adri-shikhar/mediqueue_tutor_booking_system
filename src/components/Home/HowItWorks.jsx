...
export default function HowItWorks() {
  return (
    <section className="mt-16 rounded-2xl border border-slate-200 bg-gradient-to-b from-white to-[#eef7ff] p-8">
      <h2 className="text-center text-2xl font-bold text-[#2f4aa5]">
        How It Works
      </h2>
